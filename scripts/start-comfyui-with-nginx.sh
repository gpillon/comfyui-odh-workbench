...
if [ "$API_MODE" = "true" ]; then
    # API mode flags
    ADDITIONAL_FLAGS="--base-directory /mnt/models --database-url sqlite:////tmp/comfyui-user/comfyui.db --input-directory /tmp/comfyui-input --output-directory /tmp/comfyui-output --user-directory /tmp/comfyui-user"
else
